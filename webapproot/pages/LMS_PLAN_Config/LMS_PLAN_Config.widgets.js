LMS_PLAN_Config.widgets = {
	...
	layoutBox1: ["wm.Layout", {"_classes":{"domNode":["wm_BackgroundColor_White"]},"height":"100%","horizontalAlign":"left","verticalAlign":"top","width":"100%"}, {}, {
		fancyPanel1: ["wm.FancyPanel", {"title":"[LMS_PLAN_CONFIG] ปรับแต่งข้อมูลพื้นฐานแผนงาน (Planning Management Configuration)"}, {}, {
			tabLayers_DP_Config: ["wm.TabLayers", {}, {}, {
				layer_DP_PLAN_TYPE: ["wm.Layer", {"border":"1","borderColor":"#999999","caption":"ประเภทแผนงาน","horizontalAlign":"left","themeStyleType":"ContentPanel","verticalAlign":"top"}, {}, {
				...
				layer_PLAN_STATUS: ["wm.Layer", {"border":"1","borderColor":"#999999","caption":"สถานะแผนงาน","horizontalAlign":"left","themeStyleType":"ContentPanel","verticalAlign":"top"}, {}, {
					lms_plan_statusLivePanel1: ["wm.LivePanel", {"horizontalAlign":"left","verticalAlign":"top"}, {}, {
						lms_plan_statusGridPanel: ["wm.FancyPanel", {"minHeight":"180","title":"[PLAN_STATUS] ปรับแต่งสถานะแผนงาน (Planning Status Configuration)"}, {}, {
